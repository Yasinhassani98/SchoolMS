            ...
            @role(['admin', 'superadmin'])
                ...
                <li>
                    <a href="{{ route('admin.academic-years.index') }}"
                        ...
                        <i class="fa-solid fa-calendar-days"></i><span class="nav-text">Academic Years</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.parints.index') }}" class="{{ Route::is('admin.parints.*') ? 'active' : '' }}"
                        aria-expanded="false">
                        <i class="fa-solid fa-users-line"></i><span class="nav-text">Parints</span>
                    </a>
                </li>
                <li>
