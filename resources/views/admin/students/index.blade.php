                        ...
                        <table class="table table-xs text-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $student->parint->name ?? 'null' }}</td>
                                    <td>{{ $student->address }}</td>
                                    <td>{{ $student->date_of_birth }}</td>
                                    <td>{{ $student->status }}</td>
                                    <td>
                                        <a href="{{ route('admin.students.edit', $student->id) }}"><i class="fa-solid fa-pen-to-square text-warning"></i></a>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.students.show', $student->id) }}"><i class="fa-solid fa-eye text-success"></i></a>
                                    </td>
                                    <td>
